...
public class CThostFtdcNotifyQueryAccountField extends StructObject {
	...
	/** C type : TThostFtdcSerialType */
	@Field(9)
	public CThostFtdcNotifyQueryAccountField PlateSerial(int PlateSerial) {
	...
	/** C type : TThostFtdcLastFragmentType */
	@Field(10)
	public CThostFtdcNotifyQueryAccountField LastFragment(byte LastFragment) {
	...
	/** C type : TThostFtdcSessionIDType */
	@Field(11)
	public CThostFtdcNotifyQueryAccountField SessionID(int SessionID) {
	...
	/** C type : TThostFtdcIdCardTypeType */
	@Field(13)
	public CThostFtdcNotifyQueryAccountField IdCardType(byte IdCardType) {
	...
	/** C type : TThostFtdcCustTypeType */
	@Field(15)
	public CThostFtdcNotifyQueryAccountField CustType(byte CustType) {
	...
	/** C type : TThostFtdcFutureSerialType */
	@Field(20)
	public CThostFtdcNotifyQueryAccountField FutureSerial(int FutureSerial) {
	...
	/** C type : TThostFtdcInstallIDType */
	@Field(21)
	public CThostFtdcNotifyQueryAccountField InstallID(int InstallID) {
	...
	/** C type : TThostFtdcYesNoIndicatorType */
	@Field(23)
	public CThostFtdcNotifyQueryAccountField VerifyCertNoFlag(byte VerifyCertNoFlag) {
	...
	/** C type : TThostFtdcBankAccTypeType */
	@Field(26)
	public CThostFtdcNotifyQueryAccountField BankAccType(byte BankAccType) {
	...
	/** C type : TThostFtdcBankAccTypeType */
	@Field(28)
	public CThostFtdcNotifyQueryAccountField BankSecuAccType(byte BankSecuAccType) {
	...
	/** C type : TThostFtdcPwdFlagType */
	@Field(31)
	public CThostFtdcNotifyQueryAccountField BankPwdFlag(byte BankPwdFlag) {
	...
	/** C type : TThostFtdcPwdFlagType */
	@Field(32)
	public CThostFtdcNotifyQueryAccountField SecuPwdFlag(byte SecuPwdFlag) {
	...
	/** C type : TThostFtdcRequestIDType */
	@Field(34)
	public CThostFtdcNotifyQueryAccountField RequestID(int RequestID) {
	...
	/** C type : TThostFtdcTIDType */
	@Field(35)
	public CThostFtdcNotifyQueryAccountField TID(int TID) {
	...
	/** C type : TThostFtdcTradeAmountType */
	@Field(36)
	public CThostFtdcNotifyQueryAccountField BankUseAmount(double BankUseAmount) {
	...
	/** C type : TThostFtdcTradeAmountType */
	@Field(37)
	public CThostFtdcNotifyQueryAccountField BankFetchAmount(double BankFetchAmount) {
	...
	/** C type : TThostFtdcErrorIDType */
	@Field(38)
	public CThostFtdcNotifyQueryAccountField ErrorID(int ErrorID) {
