...
public class CThostFtdcNotifyFutureSignOutField extends StructObject {
	...
	/** C type : TThostFtdcSerialType */
	@Field(9)
	public CThostFtdcNotifyFutureSignOutField PlateSerial(int PlateSerial) {
	...
	/** C type : TThostFtdcLastFragmentType */
	@Field(10)
	public CThostFtdcNotifyFutureSignOutField LastFragment(byte LastFragment) {
	...
	/** C type : TThostFtdcSessionIDType */
	@Field(11)
	public CThostFtdcNotifyFutureSignOutField SessionID(int SessionID) {
	...
	/** C type : TThostFtdcInstallIDType */
	@Field(12)
	public CThostFtdcNotifyFutureSignOutField InstallID(int InstallID) {
	...
	/** C type : TThostFtdcRequestIDType */
	@Field(19)
	public CThostFtdcNotifyFutureSignOutField RequestID(int RequestID) {
	...
	/** C type : TThostFtdcTIDType */
	@Field(20)
	public CThostFtdcNotifyFutureSignOutField TID(int TID) {
	...
	/** C type : TThostFtdcErrorIDType */
	@Field(21)
	public CThostFtdcNotifyFutureSignOutField ErrorID(int ErrorID) {
