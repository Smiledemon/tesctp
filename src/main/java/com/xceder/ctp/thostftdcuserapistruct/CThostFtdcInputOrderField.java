...
public class CThostFtdcInputOrderField extends StructObject {
    ...
    @Field(5)
    private CThostFtdcInputOrderField OrderPriceType(byte OrderPriceType) {
    ...
    @Field(6)
    private CThostFtdcInputOrderField Direction(byte Direction) {
    ...
    @Field(9)
    private CThostFtdcInputOrderField LimitPrice(double LimitPrice) {
    ...
    @Field(10)
    private CThostFtdcInputOrderField VolumeTotalOriginal(int VolumeTotalOriginal) {
    ...
    @Field(11)
    private CThostFtdcInputOrderField TimeCondition(byte TimeCondition) {
    ...
    @Field(13)
    private CThostFtdcInputOrderField VolumeCondition(byte VolumeCondition) {
    ...
    @Field(14)
    private CThostFtdcInputOrderField MinVolume(int MinVolume) {
    ...
    @Field(15)
    private CThostFtdcInputOrderField ContingentCondition(byte ContingentCondition) {
    ...
    @Field(16)
    private CThostFtdcInputOrderField StopPrice(double StopPrice) {
    ...
    @Field(17)
    private CThostFtdcInputOrderField ForceCloseReason(byte ForceCloseReason) {
    ...
    @Field(18)
    private CThostFtdcInputOrderField IsAutoSuspend(int IsAutoSuspend) {
    ...
    @Field(20)
    private CThostFtdcInputOrderField RequestID(int RequestID) {
    ...
    @Field(21)
    private CThostFtdcInputOrderField UserForceClose(int UserForceClose) {
    ...
    @Field(22)
    private CThostFtdcInputOrderField IsSwapOrder(int IsSwapOrder) {
