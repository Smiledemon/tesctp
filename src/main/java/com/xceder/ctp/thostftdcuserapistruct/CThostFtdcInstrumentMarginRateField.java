...
public class CThostFtdcInstrumentMarginRateField extends StructObject {
    ...
    @Field(1)
    private CThostFtdcInstrumentMarginRateField InvestorRange(byte InvestorRange) {
    ...
    @Field(4)
    private CThostFtdcInstrumentMarginRateField HedgeFlag(byte HedgeFlag) {
    ...
    @Field(5)
    private CThostFtdcInstrumentMarginRateField LongMarginRatioByMoney(double LongMarginRatioByMoney) {
    ...
    @Field(6)
    private CThostFtdcInstrumentMarginRateField LongMarginRatioByVolume(double LongMarginRatioByVolume) {
    ...
    @Field(7)
    private CThostFtdcInstrumentMarginRateField ShortMarginRatioByMoney(double ShortMarginRatioByMoney) {
    ...
    @Field(8)
    private CThostFtdcInstrumentMarginRateField ShortMarginRatioByVolume(double ShortMarginRatioByVolume) {
    ...
    @Field(9)
    private CThostFtdcInstrumentMarginRateField IsRelative(int IsRelative) {
