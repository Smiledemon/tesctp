...
public class CThostFtdcReqCancelAccountField extends StructObject {
	static {
		BridJ.register();
	}
	...
	/** C type : TThostFtdcSerialType */
	@Field(9)
	public CThostFtdcReqCancelAccountField PlateSerial(int PlateSerial) {
	...
	/** C type : TThostFtdcLastFragmentType */
	@Field(10)
	public CThostFtdcReqCancelAccountField LastFragment(byte LastFragment) {
	...
	/** C type : TThostFtdcSessionIDType */
	@Field(11)
	public CThostFtdcReqCancelAccountField SessionID(int SessionID) {
	...
	/** C type : TThostFtdcIdCardTypeType */
	@Field(13)
	public CThostFtdcReqCancelAccountField IdCardType(byte IdCardType) {
	...
	/** C type : TThostFtdcGenderType */
	@Field(15)
	public CThostFtdcReqCancelAccountField Gender(byte Gender) {
	...
	/** C type : TThostFtdcCustTypeType */
	@Field(17)
	public CThostFtdcReqCancelAccountField CustType(byte CustType) {
	...
	/** C type : TThostFtdcMoneyAccountStatusType */
	@Field(24)
	public CThostFtdcReqCancelAccountField MoneyAccountStatus(byte MoneyAccountStatus) {
	...
	/** C type : TThostFtdcInstallIDType */
	@Field(29)
	public CThostFtdcReqCancelAccountField InstallID(int InstallID) {
	...
	/** C type : TThostFtdcYesNoIndicatorType */
	@Field(30)
	public CThostFtdcReqCancelAccountField VerifyCertNoFlag(byte VerifyCertNoFlag) {
	...
	/** C type : TThostFtdcCashExchangeCodeType */
	@Field(32)
	public CThostFtdcReqCancelAccountField CashExchangeCode(byte CashExchangeCode) {
	...
	/** C type : TThostFtdcBankAccTypeType */
	@Field(34)
	public CThostFtdcReqCancelAccountField BankAccType(byte BankAccType) {
	...
	/** C type : TThostFtdcBankAccTypeType */
	@Field(36)
	public CThostFtdcReqCancelAccountField BankSecuAccType(byte BankSecuAccType) {
	...
	/** C type : TThostFtdcPwdFlagType */
	@Field(39)
	public CThostFtdcReqCancelAccountField BankPwdFlag(byte BankPwdFlag) {
	...
	/** C type : TThostFtdcPwdFlagType */
	@Field(40)
	public CThostFtdcReqCancelAccountField SecuPwdFlag(byte SecuPwdFlag) {
	...
	/** C type : TThostFtdcTIDType */
	@Field(42)
	public CThostFtdcReqCancelAccountField TID(int TID) {
	...
	public CThostFtdcReqCancelAccountField(Pointer pointer) {
		super(pointer);
	}
}
